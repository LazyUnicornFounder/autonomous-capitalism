  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border min-h-[calc(100vh-56px)] flex items-center py-12 md:py-24 overflow-hidden">
        <div className="flex w-full px-4 md:px-24 gap-12">
          {/* Left: headline + CTA */}
          <div className="w-full md:w-1/2 text-left flex-shrink-0 flex flex-col justify-center">
            ...
            <p className="text-muted-foreground font-body text-lg md:text-xl leading-relaxed mb-8 max-w-lg">
              Every day, AI reads hundreds of posts about the <span className="text-primary font-bold">autonomous</span> revolution on <svg className="w-5 h-5 md:w-6 md:h-6 fill-primary inline -mt-0.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> and writes you one sharp, story-driven <span className="text-primary font-bold">briefing</span> on what machines are doing in business, finance, and society. <svg className="w-5 h-5 md:w-6 md:h-6 fill-primary inline -mt-0.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> and writes you one sharp, story-driven <span className="text-primary font-bold">briefing</span> on what machines are doing in business, finance, and society.
            </p>
