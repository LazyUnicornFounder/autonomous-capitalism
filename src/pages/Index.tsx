      ...
      <header>
        <div className="flex items-center justify-between py-6 px-6 md:px-24">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="/subscribe" className="bg-primary text-primary-foreground px-4 py-1.5 font-body font-bold text-xs tracking-wider hover:bg-primary/90 transition-colors">SUBSCRIBE</a>
